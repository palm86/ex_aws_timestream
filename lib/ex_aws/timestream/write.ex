defmodule ExAws.Timestream.Write do
  ...
  @spec create_database(database_name :: database_name, opts :: create_database_opts) :: ExAws.Operation.JSON.t
  ...
  @spec update_database(database_name :: database_name, km_key_id :: pos_integer) :: ExAws.Operation.JSON.t
  ...
  @spec create_table(database_name :: database_name, km_key_id :: table_name) :: ExAws.Operation.JSON.t
  @spec create_table(database_name :: database_name, km_key_id :: table_name, create_table_opts :: create_table_opts) :: ExAws.Operation.JSON.t
  ...
  @spec delete_table(database_name :: database_name, km_key_id :: table_name) :: ExAws.Operation.JSON.t
  ...
  @spec describe_table(database_name :: database_name, km_key_id :: table_name) :: ExAws.Operation.JSON.t
  ...
  @spec update_table(database_name :: database_name, km_key_id :: table_name, retention_properties::retention_properties) :: ExAws.Operation.JSON.t
  ...
  @spec untag_resource(resource_arn :: resource_arn, tag_keys :: [binary]) :: ExAws.Operation.JSON.t
  ...
  @spec write_records(records :: [record], database_name :: database_name, table_name :: table_name) :: ExAws.Operation.JSON.t
  @spec write_records(records :: [record], database_name :: database_name, table_name :: table_name, write_records :: write_records_opts) :: ExAws.Operation.JSON.t
